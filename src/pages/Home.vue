<script setup>
import imgHome from '../assets/imgs/bg-home.png'
import speedIcon from '../assets/imgs/speed.svg'
import securityIcon from '../assets/imgs/security.svg'
import safetyIcon from '../assets/imgs/safety-time.svg'
import supportIcon from '../assets/imgs/support.svg'
...
<template>
    <div class="md:flex items-center">
        ...
        <V_Image :src="imgHome" class="w-full md:w-1/2 max-w-2xl" />
    </div>
    <div class="my-20 px-3 md:px-0">
        ...
        <ul class="md:flex md:flex-wrap items-center justify-center text-center">
            <li class=" py-6 md:px-6 md:w-1/2">
                <V_Image :src="speedIcon" class=" invert m-auto pb-2"/>
            ...
            <li class="py-6 md:px-6 md:w-1/2" >
                <V_Image :src="securityIcon" class=" invert m-auto pb-2" />
            ...
            <li class="py-6 md:px-6 md:w-1/2">
                <V_Image :src="supportIcon" class=" invert m-auto pb-2" />
            ...
            <li class="py-6 md:px-6 md:w-1/2">
                <V_Image :src="safetyIcon" class=" invert m-auto pb-2" />
